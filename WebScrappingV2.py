...
num_rows_to_scrape = 5  # Change this to the desired number of rows, or set it to None*************************************
...
airport_data_with_date.to_csv(csv_file, index=False,header=None)

# Print a message indicating the CSV file has been created
print("CSV file created successfully.")

df= pd.read_csv("outputa.csv" , header=None) 
df = df.drop(5, axis=1).dropna()